...
//    return numDecodings(s, 0, map);
  ...
  /**
   * Runtime: 1 ms, faster than 98.96% of Java online submissions for Decode Ways.
  ...
  /**
   * Runtime: 2 ms, faster than 56.56% of Java online submissions for Decode Ways.
   * Memory Usage: 35.1 MB, less than 100.00% of Java online submissions for Decode Ways.
   */
