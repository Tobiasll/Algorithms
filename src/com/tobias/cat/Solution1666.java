 ...
 * 样例 样例 1:
 *
 * 输入：a=[3,7,12,19]，k=3 输出：1 解释： There are 4 ways 3+7+12=22　　3+7+19＝29　　7+12+19＝38　　3+12+19＝34 and
 * only 29 is a prime. 样例 2:
 *
 * 输入：a=[1,2,3], k=2 输出：2 解释： There are 3 ways 1 + 2 = 3         1 + 3 = 4      2 + 3 =5 and only 3
 * and 5 are primes. 注意事项 n 不超过 1010 k 不超过 n
 */
