 ...
 * Example 1:
 *
 * Input: 00000000000000000000000000001011 Output: 3 Explanation: The input binary string
 * 00000000000000000000000000001011 has a total of three '1' bits. Example 2:
 *
 * Input: 00000000000000000000000010000000 Output: 1 Explanation: The input binary string
 * 00000000000000000000000010000000 has a total of one '1' bit. Example 3:
 *
 * Input: 11111111111111111111111111111101 Output: 31 Explanation: The input binary string
 ...
 * internal binary representation of the integer is the same whether it is signed or unsigned. In
