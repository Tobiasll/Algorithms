...
public class ExcelSheetColumnNumber171 {
  ...
  /**
   * first submit, I use a variable count to record How many 26's do we have to multiply by  , from back to front calculate each character，for example : "AAA" = A 676 + A 26 + A 1，but this time complexity is O(n²)，too slow
   * so i improve the program， no any more use the variable count，then the time complexity is O(n), it  faster than 99.98% and less than 100.00%
   */
