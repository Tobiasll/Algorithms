 ...
 * the integer is the same whether it is signed or unsigned.In Java, the compiler represents the signed integers using 2's
...
public class ReverseBits190 {
  ...
  public static void main(String[] args) {
    new Object();
    test(null, 1, new Object[1]);
  }


  public static void test(String s, Object o1, Object... args) {
