 ...
 */
public class S_609FindDuplicateFileInSystem {
    ...
    public static void main(String[] args) {
        S_609FindDuplicateFileInSystem findDuplicateFileInSystem = new S_609FindDuplicateFileInSystem();
        /*
        ...
        []
        */
        System.out.println(findDuplicateFileInSystem.findDuplicate(new String[]{"root/a 1.txt(abcd) 2.txt(efgh)", "root/c 3.txt(abcd)", "root/c/d 4.txt(efgh)", "root 4.txt(efgh)"}));
    }
}
