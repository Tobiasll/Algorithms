 ...
 *
 * Example 1: Input: prices = [1, 3, 2, 8, 4, 9], fee = 2 Output: 8 Explanation: The maximum profit
 * can be achieved by: Buying at prices[0] = 1 Selling at prices[3] = 8 Buying at prices[4] = 4
...
public class BestTimeToBuyAndSellStockWithTransactionFee714 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(bestTimeToBuyAndSellStockWithTransactionFee714
        .maxProfitByDPWithVariable(new int[]{1, 3, 2, 8, 4, 9}, 2));
  }
}
